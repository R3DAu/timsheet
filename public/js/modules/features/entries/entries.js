 ...
 */
export async function editEntry(id, timesheetIdParam) {
  ...
  // NOTE: entry.notes and entry.privateNotes contain Quill HTML. Setting innerHTML here is
  // intentional for editing. Display uses sanitizeRichText() in timesheets.js
  if (entry.notes) {
